...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-02-2026 a las 19:39:23
...
CREATE TABLE `login` (
  ...
  `status` enum('Activo','Inactico') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `login` (`id`, `user`, `password`, `role`, `status`) VALUES
(1, 'barenas', 'ArenasDb1/*', 'Admin', 'Activo');
...
INSERT INTO `users` (`id`, `user`, `password_hash`, `role`, `status`) VALUES
(1, 'barenas', '$2a$12$EL60m/KRa1s5W9LSJyejmOCkZVUR46Xh1qXzUMo3P72sZpi4iXqMy', 'Admin', 'Activo');
...
('root', '[{\"db\":\"login\",\"table\":\"users\"},{\"db\":\"login\",\"table\":\"login\"},{\"db\":\"inventario\",\"table\":\"implemento\"},{\"db\":\"inventario\",\"table\":\"departamento\"},{\"db\":\"inventario\",\"table\":\"responsable\"},{\"db\":\"inventario\",\"table\":\"propietario\"},{\"db\":\"inventario\",\"table\":\"cat_implemento\"}]');
...
('root', '2026-02-25 18:34:10', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
